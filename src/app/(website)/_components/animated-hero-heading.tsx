...
export function AnimatedHeroHeading() {
  ...
  return (
    <h1 className='h-[108px] bg-gray-900 bg-clip-text px-4 text-center text-4xl leading-normal text-transparent sm:h-auto sm:font-[350] md:text-6xl md:leading-normal'>
      {displayedText}
      <span
        className={cn(
          '-mb-2 ml-0.5 inline-block h-[44px] w-0.5 bg-gray-600 sm:h-[60px]',
