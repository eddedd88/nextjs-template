...
export function Footer() {
  return (
    <footer className='bg-primary/5 py-2'>
      <div className='text-muted-foreground flex flex-col gap-2 px-4 text-sm sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-6'>
        ...
        <div className='flex items-center justify-center gap-2'>
          ...
          <SocialLink href='https://github.com/eddedd88/nextjs-template'>
            <svg
              role='img'
              viewBox='0 0 24 24'
              xmlns='http://www.w3.org/2000/svg'
